...
func (AppModuleBasic) DefaultGenesis() json.RawMessage {
	...
	// ensure that the default bonddenom is assigned to our staking currency, if otherwise specified
	defaultGenesisState := DefaultGenesisState()
	defaultGenesisState.Params.BondDenom = assets.MicroTpaperDenom
...
func NewAppModule(keeper Keeper, accountKeeper types.AccountKeeper, supplyKeeper types.SupplyKeeper, policyKeeper cleank.Keeper) AppModule {
...
func (am AppModule) NewHandler() sdk.Handler {
	return NewHandler(am.keeper, am.policyKeeper)
}
